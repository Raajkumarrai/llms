...
if (isset($_POST['loginSubmit'])) {
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        if (
            ...
            header("Location: " . $_SERVER['PHP_SELF'] . '?error=Invalid Credential password.');
        }
        exit();
    } else {
        header("Location: " . $_SERVER['PHP_SELF'] . '?error=Invalid Credential email.');
        exit();
    }
}
?>
...
<body>
            ...
            <div class="user-box passwordbox" onclick="userBoxClk">
                ...
                <div id="eyeOpen" class="eye" onclick="eyeOpen()">
                    <svg width="17" height="12" viewBox="0 0 20 15" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M10 4.5C9.27668 4.5 8.58299 4.81607 8.07153 5.37868C7.56006 5.94129 7.27273 6.70435 7.27273 7.5C7.27273 8.29565 7.56006 9.05871 8.07153 9.62132C8.58299 10.1839 9.27668 10.5 10 10.5C10.7233 10.5 11.417 10.1839 11.9285 9.62132C12.4399 9.05871 12.7273 8.29565 12.7273 7.5C12.7273 6.70435 12.4399 5.94129 11.9285 5.37868C11.417 4.81607 10.7233 4.5 10 4.5ZM10 12.5C8.79447 12.5 7.63832 11.9732 6.78588 11.0355C5.93344 10.0979 5.45455 8.82608 5.45455 7.5C5.45455 6.17392 5.93344 4.90215 6.78588 3.96447C7.63832 3.02678 8.79447 2.5 10 2.5C11.2055 2.5 12.3617 3.02678 13.2141 3.96447C14.0666 4.90215 14.5455 6.17392 14.5455 7.5C14.5455 8.82608 14.0666 10.0979 13.2141 11.0355C12.3617 11.9732 11.2055 12.5 10 12.5ZM10 0C5.45455 0 1.57273 3.11 0 7.5C1.57273 11.89 5.45455 15 10 15C14.5455 15 18.4273 11.89 20 7.5C18.4273 3.11 14.5455 0 10 0Z" />
                    </svg>
                </div>
    ...
    <script>
        ...
        const emailValidation = () => {
            ...
            const emailRegex = /^[^0-9]\S+@\S+\.\S+$/;  // Updated regular expression
            if (email === "") {
        ...
        username.addEventListener("input", () => emailValidation());
