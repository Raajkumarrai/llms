...
$adminMessage = $urlParts[count($urlParts) - 2] . '/' . $urlParts[count($urlParts) - 1];
    ...
    <nav id="snav">
        <div class="icon">
            <img src="./LMS.jpg" height="50" width="50" style="border-radius:50%; object-fit:cover; "
                alt="Logo Not Found">
            <ul>
                <li class="<?php echo $adminMessage == 'admin/dashBoard.php' ? 'activesidebar' : '' ?>">
                ...
                <li class="<?php echo $adminMessage == 'admin/category.php' ? 'activesidebar' : '' ?>">
                ...
                <li class="<?php echo $adminMessage == 'admin/subcategory.php' ? 'activesidebar' : '' ?>">
                ...
                <li class="<?php echo $adminMessage == 'admin/book.php' ? 'activesidebar' : '' ?>">
                ...
                <li class="<?php echo $adminMessage == 'admin/message.php' ? 'activesidebar' : '' ?>">
                ...
                <li class="<?php echo $adminMessage == 'admin/members.php' ? 'activesidebar' : '' ?>">
