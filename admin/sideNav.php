...
<div id="maindiv">
    <nav id="snav">
        <div class="icon">
            <img src="./LMS.jpg" height="50" width="50" style="border-radius:50%; object-fit:cover; " alt="Logo Not Found">
            <ul>
                <li>
                    <a href="dashBoard.php"><svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                            <path d="M13.3334 26.6667V18.6667H18.6667V26.6667H25.3334V16H29.3334L16 4L2.66669 16H6.66669V26.6667H13.3334Z" />
                        </svg>
                    </a>
                    <div class="iconname">
                        <p>Dashboard</p>
                ...
                <li>
                    <a href="category.php"><svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                            <path d="M14.6667 18V28.6667H4V18H14.6667ZM16 2.66667L23.3333 14.6667H8.66667L16 2.66667ZM23.3333 17.3333C26.6667 17.3333 29.3333 20 29.3333 23.3333C29.3333 26.6667 26.6667 29.3333 23.3333 29.3333C20 29.3333 17.3333 26.6667 17.3333 23.3333C17.3333 20 20 17.3333 23.3333 17.3333Z" />
                        </svg>
                    </a>
                    <div class="iconname">
                        <p>Category</p>
                ...
                <li>
                    <a href="restriction.php"><svg width="32" height="32" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style=" margin-left: 5px;">
                            <path d="M18.6667 13.3333H4V16H18.6667V13.3333ZM18.6667 8H4V10.6667H18.6667V8ZM4 21.3333H13.3333V18.6667H4V21.3333ZM19.2 29.3333L22.6667 25.8667L26.1333 29.3333L28 27.4667L24.5333 24L28 20.5333L26.1333 18.6667L22.6667 22.1333L19.2 18.6667L17.3333 20.5333L20.8 24L17.3333 27.4667L19.2 29.3333Z" />
                        </svg>
                    </a>
                    <div class="iconname">
                        <p>Restriction</p>
                ...
                <li>
                    <a href="bookrequest.php">
                        <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" style=" margin-left: 10px;">
                            <path d="M10.09 18H2V4H0V18C0 18.5304 0.210714 19.0391 0.585786 19.4142C0.960859 19.7893 1.46957 20 2 20H10.81C10.4422 19.3865 10.1977 18.7071 10.09 18ZM16 0H11V5L9 3.5L7 5V0H6C5.46957 0 4.96086 0.210714 4.58579 0.585786C4.21071 0.960859 4 1.46957 4 2V14C4 14.5304 4.21071 15.0391 4.58579 15.4142C4.96086 15.7893 5.46957 16 6 16H10.09C10.2356 15.1376 10.568 14.3175 11.0639 13.5971C11.5598 12.8767 12.2072 12.2734 12.9607 11.8295C13.7142 11.3855 14.5557 11.1117 15.4262 11.0272C16.2967 10.9426 17.1751 11.0494 18 11.34V2C18 1.46957 17.7893 0.960859 17.4142 0.585786C17.0391 0.210714 16.5304 0 16 0ZM17 13V16H20V18H17V21H15V18H12V16H15V13H17Z" />
                        </svg>
                    </a>
                    <div class="iconname" style="display: flex; gap: 5px;">
                        <p>Book</p>
                        <p> Request</p>
                    </div>
                </li>
